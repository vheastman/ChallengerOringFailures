...
Although not a surefire validation, we are further assured in supporting the claim that the O-ring failures can be treated independently and we can use the binomial model. This validation check is on top of the analysis that Dalal et. all use to support using the binomial model.
