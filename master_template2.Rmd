...
w.n<-data.frame(Temperature=w$Temp, Failure=w$O.ring, trials=n$O.ring,Pressure200=w$P200, proportion=round(w$O.ring/n$O.ring,4))
head(w.n)
...
4) There is no multi-collinearity/perfect collinearity amongst explanatory variables.
